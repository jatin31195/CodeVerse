            ...
            {user && (
              <div className="relative">
                <button
                  ...
                  className="w-10 h-10 sm:w-12 sm:h-12 rounded-full hover:border-green-400 bg-gray-100 cursor-pointer flex items-center justify-center overflow-hidden border-2 border-blue-600"
                >
                  {user.profilePic ? (
                    <img
                      src={user.profilePic}
