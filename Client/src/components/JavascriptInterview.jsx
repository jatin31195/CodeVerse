...
const CustomImage = ({ src, alt, ...props }) => {
  ...
  const getImageSrc = (originalSrc) => {
    ...
    return `https://raw.githubusercontent.com/codeverse124/javascript/main/${originalSrc}`;
  };
...
export default function ReactInterview() {
  ...
  useEffect(() => {
    const githubRawUrl = 'https://raw.githubusercontent.com/codeverse124/javascript/main/README.md';
