...
router.put('/:ticketId/close-video', authMiddleware, ticketController.closeVideoMeet);
router.put('/:ticketId/accept-solution', authMiddleware, ticketController.acceptSolution);
